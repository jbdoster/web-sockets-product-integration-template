...
export namespace Prisma {
  ...
  */
  ...
  export type RulesCountAggregateOutputType = {
    ...
    id: number
    required: number
    event_property_data_type: number
    number_value_minimum: number
    number_value_maximum: number
    string_length_maximum: number
    regular_expression_match: number
    version: number
    event_property_key: number
    _all: number
  }


  export type RulesAvgAggregateInputType = {
    number_value_minimum?: true
    number_value_maximum?: true
    string_length_maximum?: true
    version?: true
  }
  ...
  export type RulesMinAggregateInputType = {
    ...
    id?: true
    required?: true
    event_property_data_type?: true
    number_value_minimum?: true
    number_value_maximum?: true
    string_length_maximum?: true
    regular_expression_match?: true
    version?: true
    event_property_key?: true
  }
  ...
  export type rulesSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    id?: boolean
    required?: boolean
    event_property_data_type?: boolean
    number_value_minimum?: boolean
    number_value_maximum?: boolean
    string_length_maximum?: boolean
    regular_expression_match?: boolean
    version?: boolean
    event_property_key?: boolean
  ...
  export type rulesOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"event_key" | "id" | "required" | "event_property_data_type" | "number_value_minimum" | "number_value_maximum" | "string_length_maximum" | "regular_expression_match" | "version" | "event_property_key", ExtArgs["result"]["rules"]>
  ...
  export interface rulesDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `event_key`
     * const rulesWithEvent_keyOnly = await prisma.rules.findMany({ select: { event_key: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Rules and only return the `event_key`
     * const rulesWithEvent_keyOnly = await prisma.rules.createManyAndReturn({
     ...
     * })
     * 
     * // Update zero or more Rules and only return the `event_key`
     * const rulesWithEvent_keyOnly = await prisma.rules.updateManyAndReturn({
     *   select: { event_key: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface rulesFieldRefs {
    readonly event_key: FieldRef<"rules", 'String'>
    readonly id: FieldRef<"rules", 'String'>
    readonly required: FieldRef<"rules", 'Boolean'>
    readonly event_property_data_type: FieldRef<"rules", 'String'>
    readonly number_value_minimum: FieldRef<"rules", 'Int'>
    readonly number_value_maximum: FieldRef<"rules", 'Int'>
    readonly string_length_maximum: FieldRef<"rules", 'Int'>
    readonly regular_expression_match: FieldRef<"rules", 'String'>
    readonly version: FieldRef<"rules", 'Int'>
    readonly event_property_key: FieldRef<"rules", 'String'>
  }
  ...
  export const RulesScalarFieldEnum: {
    ...
    id: 'id',
    required: 'required',
    event_property_data_type: 'event_property_data_type',
    number_value_minimum: 'number_value_minimum',
    number_value_maximum: 'number_value_maximum',
    string_length_maximum: 'string_length_maximum',
    regular_expression_match: 'regular_expression_match',
    version: 'version',
    event_property_key: 'event_property_key'
  };
  ...
  export type rulesWhereInput = {
    ...
    event_key?: StringFilter<"rules"> | string
    id?: UuidFilter<"rules"> | string
    required?: BoolNullableFilter<"rules"> | boolean | null
    event_property_data_type?: StringNullableFilter<"rules"> | string | null
    number_value_minimum?: IntNullableFilter<"rules"> | number | null
    number_value_maximum?: IntNullableFilter<"rules"> | number | null
    string_length_maximum?: IntNullableFilter<"rules"> | number | null
    regular_expression_match?: StringNullableFilter<"rules"> | string | null
    version?: IntFilter<"rules"> | number
    event_property_key?: StringFilter<"rules"> | string
  }
  ...
  export type rulesOrderByWithRelationInput = {
    ...
    event_property_data_type?: SortOrderInput | SortOrder
    number_value_minimum?: SortOrderInput | SortOrder
    number_value_maximum?: SortOrderInput | SortOrder
    string_length_maximum?: SortOrderInput | SortOrder
    regular_expression_match?: SortOrderInput | SortOrder
    version?: SortOrder
    event_property_key?: SortOrder
  }
  ...
  export type rulesScalarWhereWithAggregatesInput = {
    ...
    event_key?: StringWithAggregatesFilter<"rules"> | string
    id?: UuidWithAggregatesFilter<"rules"> | string
    required?: BoolNullableWithAggregatesFilter<"rules"> | boolean | null
    event_property_data_type?: StringNullableWithAggregatesFilter<"rules"> | string | null
    number_value_minimum?: IntNullableWithAggregatesFilter<"rules"> | number | null
    number_value_maximum?: IntNullableWithAggregatesFilter<"rules"> | number | null
    string_length_maximum?: IntNullableWithAggregatesFilter<"rules"> | number | null
    regular_expression_match?: StringNullableWithAggregatesFilter<"rules"> | string | null
    version?: IntWithAggregatesFilter<"rules"> | number
    event_property_key?: StringWithAggregatesFilter<"rules"> | string
  }
  ...
  export type rulesUpdateInput = {
    ...
    event_property_data_type?: NullableStringFieldUpdateOperationsInput | string | null
    number_value_minimum?: NullableIntFieldUpdateOperationsInput | number | null
    number_value_maximum?: NullableIntFieldUpdateOperationsInput | number | null
    string_length_maximum?: NullableIntFieldUpdateOperationsInput | number | null
    regular_expression_match?: NullableStringFieldUpdateOperationsInput | string | null
    version?: IntFieldUpdateOperationsInput | number
    event_property_key?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type rulesCountOrderByAggregateInput = {
    ...
    id?: SortOrder
    required?: SortOrder
    event_property_data_type?: SortOrder
    number_value_minimum?: SortOrder
    number_value_maximum?: SortOrder
    string_length_maximum?: SortOrder
    regular_expression_match?: SortOrder
    version?: SortOrder
    event_property_key?: SortOrder
  }
